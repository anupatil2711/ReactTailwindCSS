import imageProduct1 from '../products/1.png'; 
import imageProduct2 from '../products/2.png' 
import imageProduct3 from '../products/3.png' 
import imageProduct4 from '../products/4.png' 
import imageProduct5 from '../products/5.png' 
import imageProduct6 from '../products/6.png' 
import imageProduct7 from '../products/7.png' 
import imageProduct8 from '../products/8.png' 

export const navItems = [
    { label: "Deckchairs", href: "#" },
    { label: "Dining Chairs", href: "#" },
    { label: "Tables & Stools", href: "#" },
    { label: "Sun Loungers", href: "#" },
    { label: "Windbreaks", href: "#" },
    { label: "Parasols", href: "#" },
    { label: "Fabrics", href: "#" },
    { label: "Storage Bags", href: "#" },
  ];
